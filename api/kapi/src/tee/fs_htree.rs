...
fn authenc_init_core<M: Operation>(
    ...
    const ALG: TeeAlg = TEE_FS_HTREE_AUTH_ENC_ALG;
...
mod tests_htree_basic {
    ...
    test_fn! {
        ...
        pub fn test_htree_structure_and_access() {
            ...
            {
                let left_mut = root.left.get_mut().unwrap();
                left_mut.dirty = true;
    ...
    test_fn! {
        ...
        pub fn test_calc_and_verify_tree() {
            ...
            let right_child = HtreeNode::new(3, node_image_r);
            let left_left_child = HtreeNode::new(4, node_image_ll);
            let left_right_child = HtreeNode::new(5, node_image_lr);
...
mod tests_find_closest_node {
    ...
    fn build_test_tree() -> TeeFsHtree {
        ...
        let node4 = HtreeNode::new(4, TeeFsHtreeNodeImage::default()); // ID 4 (level 3) - Left of 2
        let node5 = HtreeNode::new(5, TeeFsHtreeNodeImage::default()); // ID 5 (level 3) - Right of 2
        let node6 = HtreeNode::new(6, TeeFsHtreeNodeImage::default()); // ID 6 (level 3) - Left of 3
...
mod tests_get_node {
    ...
    fn build_partial_tree() -> TeeFsHtree {
        ...
        let node3 = HtreeNode::new(3, TeeFsHtreeNodeImage::default());
        let node4 = HtreeNode::new(4, TeeFsHtreeNodeImage::default());
...
pub mod tests_fs_htree {
    ...
    test_fn! {
        ...
        fn test_tee_fs_htree_open() {
            let fd = FileVariant::open("test_fs_htree_open.bin", FS_OFLAG_DEFAULT, FS_MODE_644).unwrap();
